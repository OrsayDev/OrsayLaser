...
class gainView:
    ...
    def __init__(self, instrument: gain_inst.gainDevice):
        ...
        self.hv_slider_ratio = ui.create_slider(name='hv_slider_ratio', minimum=-100, maximum=100, width=250,
                                          value='@binding(instrument.hv_ratio_f)')
        self.hv_value_ratio = ui.create_label(text='@binding(instrument.hv_ratio_f)')
        ...
        self.hv_ratio_row = ui.create_row(ui.create_stretch(), self.hv_label_ratio, ui.create_spacing(10),
                                          self.hv_value_ratio, ui.create_spacing(10), self.hv_slider_ratio)
